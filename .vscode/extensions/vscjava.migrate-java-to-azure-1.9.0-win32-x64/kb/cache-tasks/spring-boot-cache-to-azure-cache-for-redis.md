---
id: spring-boot-cache-to-azure-cache-for-redis
title: Migrate Spring Boot Cache (In-Memory) to Azure Cache for Redis
description: Provides specifications for migrating from Spring Boot Cache (In-Memory) to Azure Cache for Redis
