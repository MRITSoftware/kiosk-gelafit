---
id: local-session-management-in-a-spring-app-to-azure-cache-for-redis
title: Migrate local session management in a spring app to Azure Cache for Redis
description: Provides specifications for migrating from local session management in a spring app to Azure Cache for Redis
hierarchy: Cache Tasks
showTask: false
---
