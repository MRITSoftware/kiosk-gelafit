---
id: infinispan-to-azure-cache-for-redis
title: Migrate Infinispan to Azure Cache for Redis
description: Provides specifications for migrating from Infinispan to Azure Cache for Redis
