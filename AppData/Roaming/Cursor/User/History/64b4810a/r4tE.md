...
- ✅ **Aparece** apenas após clicar em "Iniciar" E ter feeds configurados
- ✅ **Oculta** na tela de login (sempre oculto por padrão)
- ✅ **Não aparece** se o array de feeds estiver vazio
