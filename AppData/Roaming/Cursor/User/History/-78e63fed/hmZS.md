...
### 2. Importar Extratos
1. **Upload Simples**: Acesse "Upload de Extratos" para arquivos únicos (PDF, OFX, CSV ou Excel)
2. **Processamento em Lote**: Acesse "Processar PDFs" para até 5 PDFs simultaneamente
3. Selecione a empresa
4. Faça upload do(s) arquivo(s)
5. O sistema processará automaticamente com OCR para PDFs
6. Visualize o preview e baixe o Excel gerado
...
### PDF (Novo!)
- **OCR Automático**: Extração de texto usando Tesseract.js
- **Detecção de Bancos**: Reconhecimento automático de Itaú, Bradesco, Caixa, Santander, BB, Nubank, Inter, Sicoob, Sicredi
- **Detecção de Métodos**: Identificação de PIX, TED, DOC, transferências, boletos, cartões
- **Processamento em Lote**: Até 5 PDFs simultaneamente
- **Conversão para Excel**: Geração automática de planilhas organizadas
