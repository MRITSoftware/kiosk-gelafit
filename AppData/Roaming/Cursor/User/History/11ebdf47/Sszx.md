...
Sistema inteligente para envio automático de mensagens via WhatsApp Web com detecção avançada de carregamento e interface manual.
...
- ✅ **Interface Dupla**: Automática (Excel) e Manual (Links)
